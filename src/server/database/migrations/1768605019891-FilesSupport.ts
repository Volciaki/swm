...
export class FilesSupport1768605019891 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			'CREATE TABLE "file_references" ("id" character varying NOT NULL, "size_bytes" integer NOT NULL, "mime_type" character varying NOT NULL, "path" character varying NOT NULL, "is_public" boolean NOT NULL, "public_url" character varying, "metadata" json NOT NULL, CONSTRAINT "PK_29140177cb876eafdee7340dccc" PRIMARY KEY ("id"))'
		);
