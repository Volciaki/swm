...
export class Notifications1768853259695 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query("CREATE TABLE \"notifications\" (\"id\" character varying NOT NULL, \"type\" character varying NOT NULL, \"issued_date\" TIMESTAMP NOT NULL, \"title\" character varying NOT NULL, \"message\" character varying NOT NULL, CONSTRAINT \"PK_6a72c3c0f683f6462415e653c3a\" PRIMARY KEY (\"id\"))");
