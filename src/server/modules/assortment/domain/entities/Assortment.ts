...
export class Assortment {
	...
	get hasExpired() { return this._hasExpired };
	get hasExpiredNotification() { return this._hasExpiredNotification };
	get isCloseToExpiration() { return this._isCloseToExpiration };
	get isCloseToExpirationNotification() { return this._isCloseToExpirationNotification };
	...
	set isCloseToExpirationNotification(value: NotificationVO | null) { this._isCloseToExpirationNotification = value };
	set hasExpiredNotification(value: NotificationVO | null) { this._hasExpiredNotification = value };
